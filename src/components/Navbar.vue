<template>
  <nav
    class="navbar navbar-expand-xl navbar-dark primary-color"
        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0 text-uppercase">
          ...
          >
            <li class="nav-item">
              <a
                class="nav-link"
                :class="{ active: this.$route.name === 'trade' }"
                href="/trade"
                >Trade</a
              >
            </li>
          ...
          >
            <li class="nav-item">
              <a
                class="nav-link"
                :class="{ active: this.$route.name === 'invest' }"
                href="/invest"
                >Liquidity pool</a
              >
            </li>
          ...
          >
            <li class="nav-item">
              <a
                class="nav-link"
                :class="{ active: this.$route.name === 'portfolio' }"
                href="/portfolio"
                >Portfolio</a
              >
            </li>
          ...
          >
            <li class="nav-item">
              <a
                class="nav-link"
                :class="{ active: this.$route.name === 'governance' }"
                href="/governance"
                >DOD On-Chain Governance</a
              >
            </li>
          </router-link>
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
              <li>
                <a
                  class="dropdown-item"
                  target="_blank"
                  href="https://dune.xyz/dod/DeFi-Options?period=3months"
                >
              ...
              <li>
                <a
                  class="dropdown-item"
                  target="_blank"
                  href="https://docs.defioptions.org/"
                >
              ...
              <li>
                <a
                  class="dropdown-item"
                  target="_blank"
                  href="https://web.libera.chat/#DeFiOptionsDAO"
                >
              ...
              <li>
                <a
                  class="dropdown-item"
                  target="_blank"
                  href="https://discord.gg/WCeKgHNz3z"
                >
              ...
              <li>
                <a
                  class="dropdown-item"
                  target="_blank"
                  href="https://forum.defioptions.org/"
                >
              ...
              <li>
                <a
                  class="dropdown-item"
                  target="_blank"
                  href="https://github.com/DeFiOptions"
                >
              ...
              <li>
                <a
                  class="dropdown-item"
                  target="_blank"
                  href="https://snapshot.org/#/defioptionsdao.eth"
                >
              ...
              <li>
                <a
                  class="dropdown-item"
                  target="_blank"
                  href="https://reddit.com/r/DeFiOptionsDAO/"
                >
              ...
              <li>
                <a
                  class="dropdown-item"
                  target="_blank"
                  href="https://t.me/DeFiOptionsDiscussions"
                >
              ...
              <li>
                <a
                  class="dropdown-item"
                  target="_blank"
                  href="https://twitter.com/DeFiOptionsDAO"
                >
